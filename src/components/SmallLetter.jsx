...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Yo Dude,<br /><br />Paiseh ah, only can give you this simple and small website. Not much one, but hope this can be your best gift ever, can or not?<br /><br />Sandreno</p>
    </div>
